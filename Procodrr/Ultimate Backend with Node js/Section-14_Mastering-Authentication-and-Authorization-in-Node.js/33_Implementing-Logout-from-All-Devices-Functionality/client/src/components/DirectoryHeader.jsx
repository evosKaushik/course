...
function DirectoryHeader({
  ...
  const handleLogoutFormAllDevices = async () => {
    if (!confirm("Are you confirm to logout form all devices")) {
      setShowUserMenu(false);
      return;
    }
    try {
            ...
            <div className="user-menu">
              {loggedIn ? (
                <>
                  ...
                  <div
                    className="user-menu-item login-btn"
                    onClick={handleLogoutFormAllDevices}
                  >
                    <FaSignOutAlt className="menu-item-icon-red" />
                    <span>Logout form all devices</span>
                  </div>
                </>
              ) : (
                <>
